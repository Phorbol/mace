...
def summarize_case(root: Path, case_dir: Path, manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    row: dict[str, Any] = {
        ...
        "lr_wsd_warmup_steps": manifest.get("lr_wsd_warmup_steps"),
        "lr_wsd_warmup_ratio": manifest.get("lr_wsd_warmup_ratio"),
        "lr_wsd_warmup_start_factor": manifest.get("lr_wsd_warmup_start_factor"),
        ...
        "loss_prefactor_schedule": manifest.get("loss_prefactor_schedule"),
        "loss_prefactor_start_update": manifest.get("loss_prefactor_start_update"),
        "loss_prefactor_end_update": manifest.get("loss_prefactor_end_update"),
        "lr": manifest.get("lr"),
...
def _comparison_row(baseline: dict[str, Any], candidate: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "loss_prefactor_schedule": candidate.get("loss_prefactor_schedule") or baseline.get("loss_prefactor_schedule"),
        "loss_prefactor_start_update": candidate.get("loss_prefactor_start_update") or baseline.get("loss_prefactor_start_update"),
        "loss_prefactor_end_update": candidate.get("loss_prefactor_end_update") or baseline.get("loss_prefactor_end_update"),
...
def _ablation_row(
    ...
    return {
        ...
        "loss_prefactor_schedule": row.get("loss_prefactor_schedule"),
        "loss_prefactor_start_update": row.get("loss_prefactor_start_update"),
        "loss_prefactor_end_update": row.get("loss_prefactor_end_update"),
